...
import type { Order, Product } from "@/pages/Dashboard"
...
const AttendeeInterface = ({ onOrderSubmit, orders }: AttendeeInterfaceProps) => {
  ...
  const handleSubmitOrder = async () => {
    ...
    const newOrder = {
      ...
      products: selectedProducts,
      status: "pending_payment" as const,
      attendee: `${attendee.fullName} - ${attendee.role}`,
